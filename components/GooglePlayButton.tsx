  ...
  return (
    ...
    >
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M3 20.5v-17c0-.59.34-1.11.84-1.35L13.69 12 3.84 21.85c-.5-.25-.84-.76-.84-1.35z" fill="#4285F4"/>
        <path d="M16.81 15.12L6.05 21.34l8.49-8.49 2.27 2.27z" fill="#34A853"/>
        <path d="M20.16 10.81c.34.27.59.69.59 1.19 0 .5-.22.9-.57 1.18L17.89 14.5l-2.5-2.5 2.5-2.5 2.27 1.31z" fill="#FBBC04"/>
      ...
      <div className="flex flex-col items-start leading-tight">
        ...
        <span className="text-lg sm:text-2xl leading-[1.1] font-semibold tracking-tight">Google Play</span>
      </div>
      {disabled && (
