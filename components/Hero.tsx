      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Main Headline */}
            <h1
              className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
            ...
            {/* Subtitle */}
            <p
              className={`text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-6 md:mb-8 leading-relaxed transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              Personalized AI exercises, chat support, and progress tracking-all from home.
            </p>

            <div
              className={`flex flex-wrap justify-center lg:justify-start items-center gap-4 mb-8 md:mb-12 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              <AppStoreButton />
            ...
            {/* Stats */}
            <div
              className={`grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              <div className="text-center lg:text-left">
                ...
                <p className="text-xs sm:text-xs md:text-sm text-gray-600 dark:text-gray-300 leading-tight">
                  Children worldwide
                </p>
              </div>
              <div className="text-center lg:text-left">
