  ...
  const mainFeatures = [
    {
      ...
      description: 'Advanced machine learning algorithms create personalized exercises that adapt to your child\'s unique learning style and pace.',
    ...
    },
    {
      ...
      description: 'AI-powered chat assistant designed specifically for special needs care, available 24/7 for guidance and support.',
    ...
    },
    {
      ...
      description: 'Comprehensive tracking and analytics provide insights into your child\'s development with detailed reports and milestones.',
    ...
    },
    {
      ...
      description: 'Enterprise-grade security ensures your child\'s data is protected with HIPAA-compliant encryption and privacy controls.',
    ...
    <section id="features-section" className="section-padding bg-gray-50 dark:bg-gray-800">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <div className={`inline-flex items-center px-4 py-2 rounded-full bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 text-sm font-medium mb-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <p className={`text-xl text-gray-600 dark:text-gray-300 mb-12 transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Nuroo combines cutting-edge AI technology with personalized support to create 
            the most comprehensive platform for children with special needs.
          </p>
        </div>
