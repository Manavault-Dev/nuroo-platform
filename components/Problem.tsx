    ...
    <section id="problem-section" className="section-padding bg-gray-50 dark:bg-gray-800">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <div className={`inline-flex items-center px-4 py-2 rounded-full bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 text-sm font-medium mb-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <p className={`text-xl text-gray-600 dark:text-gray-300 mb-12 transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            With 240+ million children worldwide living with disabilities and developmental challenges, access to quality support remains a significant barrier for most families.
          </p>
        </div>
        ...
        <div className={`mt-16 text-center transition-all duration-700 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              Every day without proper support, children with special needs miss critical developmental opportunities. 
              Families face emotional and financial stress while struggling to provide the care their children need. 
              <strong className="text-gray-900 dark:text-white"> We believe every child deserves access to quality support, regardless of location or financial circumstances.</strong>
            </p>
          </div>
        </div>
      </div>
